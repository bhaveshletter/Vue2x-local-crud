...
Vue.component('album', {
  ...
  template: '<div> Total {{ message || result.length }} albums. </div>',  
  created: function(){
    this.getData()
  },
  methods: {
...
Vue.component('user', {
  ...
  template: '<div> Total {{ message || result.length }} users.</div>',
  created: function(){
    this.getData()
  },
  methods: {
...
Vue.component('post', {
  ...
  template: '<div> Total {{ message || result.length }} posts. </div>',
  created: function(){
    this.getData()
  },
  methods: {
...
var queAnsWatch = new Vue({
  ...
  data: {
    question: '',
    answer: 'Type anything which must include ?',
    photos: []
  },
  watch: {
